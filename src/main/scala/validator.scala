...
// Pair erasure, string weakening and other type flattening
  ...
  def semanticErrorOccurred(reason: String, pos: (Int, Int))(implicit errors: mutable.ListBuffer[WaccError], source: String, waccLines: Array[String]): Unit = {
  ...
  def checkExpr(expr: LValue, varsInScope: Map[String, String])(implicit errors: mutable.ListBuffer[WaccError],
  ...
  private def checkArrayIndex(exprs: List[Expr], varsInScope: Map[String, String])(implicit errors: mutable.ListBuffer[WaccError],
                                                                                   symTable: mutable.Map[String, Type],
                                                                                   funcTable: List[Func], source: String,
  ...
  def checkExpr(expr: RValue, varsInScope: Map[String, String])(implicit errors: mutable.ListBuffer[WaccError],
                                                                symTable: mutable.Map[String, Type],
                                                                funcTable: List[Func], source: String,
  ...
  def checkExpr(expr: Expr, varsInScope: Map[String, String])(implicit errors: mutable.ListBuffer[WaccError],
                                                              symTable: mutable.Map[String, Type],
                                                              funcTable: List[Func], source: String,
  ...
  def checkUnOp(expr: UnOpp, varsInScope: Map[String, String])(implicit errors: mutable.ListBuffer[WaccError],
                                                               symTable: mutable.Map[String, Type],
                                                               funcTable: List[Func], source: String,
  ...
  def checkBinOp(expr: BinOpp, varsInScope: Map[String, String])(implicit errors: mutable.ListBuffer[WaccError],
                                                                 symTable: mutable.Map[String, Type],
                                                                 funcTable: List[Func], source: String,
