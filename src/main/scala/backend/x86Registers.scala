...
object x86Registers {
  ...
  case class x86ReturnRegister() extends x86Registers(RAX(), EAX(), AX(), AL())
  ...
  case class x86DataReg() extends x86Registers(RDX(), EDX(), DX(), DL())
  ...
  case class x86CounterReg() extends x86Registers(RCX(), ECX(), CX(), CL())
  ...
  case class x86Reg8() extends x86Registers(R8(), R8D(), R8W(), R8B())
  ...
  case class x86Reg9() extends x86Registers(R9(), R9D(), R9W(), R9B())
  ...
  case class x86BasePointer() extends x86Registers(RBP(), EBP(), BP(), BPL())
  ...
  case class x86StackPointer() extends x86Registers(RSP(), ESP(), SP(), SPL())
  ...
  case class x86BaseReg() extends x86Registers(RBX(), EBX(), BX(), BL())
  ...
  case class x86Reg10() extends x86Registers(R10(), R10D(), R10W(), R10B())
  ...
  case class x86Reg11() extends x86Registers(R11(), R11D(), R11W(), R11B())
  ...
  case class x86Reg12() extends x86Registers(R12(), R12D(), R12W(), R12B())
  ...
  case class x86Reg13() extends x86Registers(R13(), R13D(), R13W(), R13B())
  ...
  case class x86Reg14() extends x86Registers(R14(), R14D(), R14W(), R14B())
  ...
  case class x86Reg15() extends x86Registers(R15(), R15D(), R15W(), R15B())
